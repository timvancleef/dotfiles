...
__pulumi_handle_go_custom_completion()
{
    ...
    # Calling ${words[0]} instead of directly pulumi allows handling aliases
    args=("${words[@]:1}")
...
_pulumi_about()
{
    ...
    flags+=("--emoji")
    flags+=("-e")
    flags+=("--fully-qualify-stack-names")
    flags+=("-Q")
    flags+=("--logflow")
    flags+=("--logtostderr")
    flags+=("--memprofilerate=")
    two_word_flags+=("--memprofilerate")
...
_pulumi_config_env_add()
{
    last_command="pulumi_config_env_add"
...
_pulumi_config_env_init()
{
    last_command="pulumi_config_env_init"
    ...
    local_nonpersistent_flags+=("--env=")
    flags+=("--keep-config")
    local_nonpersistent_flags+=("--keep-config")
    flags+=("--show-secrets")
    local_nonpersistent_flags+=("--show-secrets")
    flags+=("--yes")
    flags+=("-y")
...
_pulumi_config_env_ls()
{
    last_command="pulumi_config_env_ls"
...
_pulumi_config_env_rm()
{
    last_command="pulumi_config_env_rm"
...
_pulumi_config_env()
{
    last_command="pulumi_config_env"
...
_pulumi_org_search_ai()
{
    last_command="pulumi_org_search_ai"
...
_pulumi_org_search()
{
    last_command="pulumi_org_search"
...
_pulumi_package_get-mapping()
{
    last_command="pulumi_package_get-mapping"
...
_pulumi_preview()
{
    ...
    flags+=("--show-config")
    flags+=("--show-policy-remediations")
    flags+=("--show-reads")
    flags+=("--show-replacement-steps")
    flags+=("--show-sames")
    flags+=("--show-secrets")
...
_pulumi_state_upgrade()
{
    last_command="pulumi_state_upgrade"
